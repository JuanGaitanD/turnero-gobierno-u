...
* [JDBC API](https://docs.spring.io/spring-boot/3.5.7.RELEASE/reference/data/sql.html)
* [Spring Data JPA](https://docs.spring.io/spring-boot/3.5.7.RELEASE/reference/data/sql.html#data.sql.jpa-and-spring-data)
* [Spring Data JDBC](https://docs.spring.io/spring-boot/3.5.7.RELEASE/reference/data/sql.html#data.sql.jdbc)
